...
const quizArray = [
   ...
   {
      id: "10",
      question: "What does Bayes Theorem help determine? ",
      options: ["Independent Events", "Two Events Occurring Simultaneously", "Conditional Probability", "Generalized Probabity"],
...
nextBtn.addEventListener(
   ...
   (displayNext = () => {
      ...
      if (questionCount == quizArray.length) {
         ...
         //user score
         userScore.innerHTML =
            "Your score is " + scoreCount + " out of " + questionCount + " \u2248 " + Math.round((scoreCount / questionCount) * 100) + "%";
      } else {
...
var x843bz = document.querySelector('.wjyt')
//Timer
const timerDisplay = () => {
